...
function ProfileCard({ profile, isActive, onUse, onEdit, onDelete }) {
  const cliTypes2 = getCliTypes();
  const cliType = cliTypes2.find((c) => c.id === profile.cliTypeId);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `rounded-xl p-4 bg-surface border shadow-card transition-colors duration-200 ${isActive ? "border-primary ring-2 ring-primary/20" : "border-gray-200 hover:border-gray-300 hover:shadow-card-hover"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-text-primary m-0 truncate", children: profile.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-text-secondary mt-1", children: cliType?.name ?? profile.cliTypeId }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-text-muted mt-0.5", "aria-hidden": true, children: "用量：—" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: onUse,
              className: `inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium cursor-pointer transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 min-h-[44px] min-w-[44px] ${isActive ? "bg-primary text-white border border-primary cursor-default" : "bg-primary text-white border border-primary hover:bg-primary-hover hover:border-primary-hover"}`,
              "aria-label": isActive ? "当前使用中" : "使用此配置",
              children: [
                isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 shrink-0", "aria-hidden": true }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-4 h-4 shrink-0", "aria-hidden": true }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: isActive ? "当前使用" : "使用此配置" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "aria-label": "编辑方案",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "w-4 h-4", "aria-hidden": true })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
...
function ProfileForm({ profile, onSave, onCancel }) {
  ...
  const [cliTypeId, setCliTypeId] = reactExports.useState(profile?.cliTypeId ?? cliTypes2[0]?.id ?? "");
  const [env, setEnv] = reactExports.useState(profile?.env ?? {});
  const selectedCli = cliTypes2.find((c) => c.id === cliTypeId);
  reactExports.useEffect(() => {
    if (!selectedCli) return;
    const next = {};
    for (const def of selectedCli.envKeys) {
      const val = env[def.key];
      next[def.key] = val !== void 0 && val !== null ? val : selectedCli.envDefaults[def.key] ?? "";
    }
    setEnv(next);
  }, [cliTypeId]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await window.clicraft.saveProfile(p2);
      if (result.success) {
        onSave();
      } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-text-primary m-0 mb-5", children: profile ? "编辑方案" : "新建方案" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "profile-name", className: "block text-sm font-medium text-text-secondary mb-1", children: "方案名称" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "profile-name",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "profile-clitype", className: "block text-sm font-medium text-text-secondary mb-1", children: "CLI 类型" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              id: "profile-clitype",
              ...
              children: cliTypes2.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: c.id, children: c.name }, c.id))
            }
          )
        ] }),
        selectedCli?.envKeys.map((def) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "label",
            {
              htmlFor: `env-${def.key}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ...
              autoComplete: def.secret ? "off" : void 0,
              className: "w-full px-3 py-2 rounded-lg border border-gray-300 bg-white text-text-primary placeholder:text-text-muted transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            }
          )
        ] }, def.key)),
        saveError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-red-600", role: "alert", children: saveError }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mt-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "w-4 h-4 shrink-0", "aria-hidden": true }),
                "取消"
              ]
            }
          )
...
function ActivateToast({ command, commandPs1, onClose }) {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { id: "activate-toast-title", className: "text-base font-semibold text-text-primary m-0", children: "已生成激活脚本" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-secondary mb-4", children: "请在要使用该 CLI 的终端中执行以下命令，环境变量将立即生效。若未生效，可关闭终端后重新打开再执行。" }),
            commandPs1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-medium text-text-muted mb-1", children: "CMD" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-start", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "flex-1 min-w-0 p-3 rounded-lg bg-surface-muted border border-gray-200 text-sm font-mono text-text-primary break-all overflow-x-auto", children: command }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-medium text-text-muted mb-1", children: "PowerShell" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-start", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "flex-1 min-w-0 p-3 rounded-lg bg-surface-muted border border-gray-200 text-sm font-mono text-text-primary break-all overflow-x-auto", children: commandPs1 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-4 h-4", "aria-hidden": true }),
                        "复制"
                      ]
                    }
                  )
              ...
              copied && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary font-medium", role: "status", children: "已复制到剪贴板" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "p-3 rounded-lg bg-surface-muted border border-gray-200 text-sm font-mono text-text-primary break-all overflow-x-auto", children: command }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    "aria-label": "复制命令",
                    children: [
                      copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-primary", "aria-hidden": true }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-4 h-4", "aria-hidden": true }),
                      "复制命令"
                    ]
                  }
                ),
                copied && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-primary font-medium", role: "status", children: "已复制到剪贴板" })
              ] })
            ] }),
...
function Dashboard({ profiles, activeProfileId, onRefresh, onActivate }) {
  ...
  const handleDelete = async (id2) => {
    ...
    try {
      await window.clicraft.deleteProfile(id2);
      await onRefresh();
      if (activeProfileId === id2) onActivate(null);
    } catch (err) {
      const message = err instanceof Error ? err.message : String(err);
      alert("删除失败：" + message);
    }
  ...
  if (editing || creating) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-6 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProfileForm,
      {
        profile: editing ?? void 0,
        onSave: handleSave,
        onCancel: () => {
          setEditing(null);
          setCreating(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-6 py-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-text-primary m-0 tracking-tight", children: "CliCraft" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          "aria-label": "新建方案",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4 shrink-0", "aria-hidden": true }),
            "新建方案"
          ]
        }
      )
    ] }),
    profiles.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 px-6 bg-surface rounded-xl border border-dashed border-gray-300 text-text-secondary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "m-0 text-text-secondary", children: "还没有任何配置方案" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-text-muted text-sm", children: "点击「新建方案」添加第一套配置（如 DeepSeek、智谱等）" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-3 list-none p-0 m-0", children: profiles.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProfileCard,
      {
        profile: p2,
        isActive: p2.id === activeProfileId,
        onUse: () => handleActivate(p2),
        onEdit: () => setEditing(p2),
        onDelete: () => handleDelete(p2.id)
      }
    ) }, p2.id)) }),
...
function App() {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: 24, textAlign: "center" }, children: "加载中…" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Dashboard,
    {
